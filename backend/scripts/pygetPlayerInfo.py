...
from .helperFunctions import * #have to run like this in terminal: python -m scripts.pygetPlayerInfo
...
#print(get_player_info("http://onlinecollegebasketball.org/player/223193"))
